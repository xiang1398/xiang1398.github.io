...
핵심은 같은 과거시간 안에서도 사건을 하나의 전체로 보느냐, 내부의 진행·습관적 국면을 보느냐가 달라진다는 점이다.
...
이 예들의 핵심은 첫째 동사의 미완료상이 지속되는 장면을 배경(background)으로 제시하고, 둘째 동사의 완료상 사건이 그 배경 내부에 하나의 전체적 사건(event)으로 놓인다는 것이다. *John was reading when I entered*에서 *was reading*은 독서 장면을 배경으로 펼쳐 놓고, *I entered*는 그 배경 내부의 한 지점에 놓인 하나의 전체적 사건으로 제시된다. 미완료상은 배경 장면의 시작과 끝을 직접 말하지 않지만, 완료상 사건은 그 내부 시간축에 위치한다.
...
콤리의 핵심 방법론은 의미적 범주와 개별 언어의 형식을 구별하는 데 있다. 모든 언어가 *today, the year before last, at five o’clock* 같은 어휘를 이용하여 시간을 표현할 수 있다고 해서 모두 문법적 시제를 갖는 것은 아니다. 시간관계가 문법적으로 체계화되어 있어야 그 언어가 시제를 가진다고 말할 수 있다. 상도 마찬가지이다. 완료상적·미완료상적 의미를 표현할 수 있다는 사실과, 그 대립이 특정한 문법범주로 문법화되어 있다는 사실은 구별해야 한다.
...
핀란드어의 목적어 격 대립도 같은 문제를 보여 준다. *hän luki kirjan*과 *hän luki kirjaa*에서는 전체 목적어와 부분격의 차이가 상적 해석과 연결된다. 그러나 부분격의 기본적 의미는 대상의 일부가 영향을 받는다는 데 있으므로 partitive = imperfective로 일반화해서는 안 된다.
...
형식적 표현의 종류도 한정할 필요가 없다. 스페인어 *leyó : leía*처럼 굴절형태론적 대립일 수도 있고, 영어 *he read : he was reading*처럼 우언적(periphrastic) 구성일 수도 있다. 중요한 것은 상이 반드시 하나의 접사나 굴절어미로 표시되는가가 아니라 의미적 대립이 체계적으로 형식화되어 있는가이다.
...
이상적인 분석은 한 형식의 여러 개별 용법을 하나의 일반적 의미로부터 예측하는 것이다. 이처럼 모든 용법을 관통하는 일반 의미를 Gesamtbedeutung이라 한다. 그러나 하나의 일반 의미가 반드시 존재한다고 미리 가정해서는 안 된다. 한편 여러 의미 중 중심적이고 전형적인 의미를 Grundbedeutung(기본 의미)이라 하며, 주변적·확장된 의미는 *Nebenbedeutungen*으로 다룰 수 있다.
...
끝으로 콤리는 상태(state), 사건(event), 과정(process)을 포괄하기 위해 situation이라는 일반 용어를 사용한다. 0장에서는 상태를 정적인 장면, 사건과 과정을 동적인 장면으로 두고, 과정은 미완료상적으로 내부 진행이 보이는 동적 장면, 사건은 완료상적으로 하나의 전체로 보이는 동적 장면으로 잠정 구별한다. 세부적인 어휘적 상의 문제는 제2장에서 본격적으로 다룬다.
